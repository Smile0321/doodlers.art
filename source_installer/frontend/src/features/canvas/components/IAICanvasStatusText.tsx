...
import { requestUnifiedCanvasImg } from 'app/actions/actionsTypes';
...
const selector = createSelector(
  ...
  (canvas) => {
    ...
    return {
      ...
      widthUC: scaledBoxWidth,
      heightUC: scaledBoxHeight,
    };
  },
  {
    memoizeOptions: {
...
const IAICanvasStatusText = () => {
  ...
  useEffect(() => {
    dispatch(requestUnifiedCanvasImg(widthUC, heightUC));
  }, [widthUC, heightUC]);
